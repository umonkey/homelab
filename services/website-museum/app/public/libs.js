/* lib/jquery/jquery-1.11.2.min.js */ /*! jQuery v1.11.2 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */
...
/* lib/jcrop/jquery.Jcrop.min.js */ (function($){$.Jcrop=function(obj,opt){var options=$.extend({},$.Jcrop.defaults),docOffset,_ua=navigator.userAgent.toLowerCase(),is_msie=/msie/.test(_ua),ie6mode=/msie [1-6]\./.test(_ua);function px(n){return Math.round(n)+'px';}
...
/* lib/leaflet/Control.FullScreen.js */ (function () {
